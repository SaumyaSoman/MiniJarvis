...
public class PMPDB {
	...
	public void populate() throws Exception{
		indexes.Populate();
		//System.out.println("index..."+indexes.toString());
	...
	private static ArrayList<String> readColumn(String file) throws Exception{
        ...
        din.close();
       // System.out.println("Read List..."+l.toString());
        return l;
    }
	...
	public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            folder = "C:\\Users\\Saumya\\AppData\\Local\\Google\\Picasa2\\db3\\";

            //if(line.hasOption(PARAM_OUTPUT_FOLDER)){
            	output = "E:\\winlab\\training";
