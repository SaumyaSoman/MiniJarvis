...
public class Read {
    ...
    public static void main(String args[])
            throws Exception
        {
    	//String db= "C:\\Users\\Saumya\\AppData\\Local\\Google\\Picasa2\\db3\\imagedata_suggestionpersonalbumid.pmp" ;
    	String db= "C:\\Users\\Saumya\\AppData\\Local\\Google\\Picasa2\\db3\\thumbindex.db" ;
